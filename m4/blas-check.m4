...
if test -n "$BLAS_VAL"; then
	...
	CBLAS="yes"	 	
	CBLAS_FLAG="-DGB_HAVE_CBLAS -I${srcdir}"
		...
		if test -r "$BLAS_VAL/lib/libcblas.a" ; then 
			...
			case `./config.guess` in
				...
				x86_64-*-linux-gnu)
					...
					;;
				*)
					echo "Sorry unsupported arch, please complain in gb-use discussion group";
					;;
			esac	
...
AM_CONDITIONAL(GB_HAVE_BLAS, test "x$HAVE_BLAS" = "xyes")
